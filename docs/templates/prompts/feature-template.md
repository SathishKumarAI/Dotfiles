...
- If it spans many files or you're unsure of scope, ask it to break the work into
  steps and do them one at a time, verifying each.

> Related: [`plan-feature.md`](plan-feature.md) turns a fuzzy request into a plan;
> this template is for when you already know the feature and want it built right.
